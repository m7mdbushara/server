    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{ __('طلبات التقديم التي تم الموافقة عليها') }}</span>
                ...
                <table class="table table-striped table-row-bordered gy-5 gs-7 border rounded" id="kt_datatable_example_5">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                            <a href="{{ route('admin.finance-requests.get-invoice',$financeRequest->id) }}" class="btn btn-success">
                              عرض
                            </a>
                           </td>
